<h2><a href="https://www.geeksforgeeks.org/problems/fake-profile3906/1?page=1&category=Strings&difficulty=Basic&sortBy=difficulty">Fake Profile</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">There is a hacker named "Vijay" who&nbsp;has developed a method to check whether an id at some social networking site is fake or real using its username.</span></p>
