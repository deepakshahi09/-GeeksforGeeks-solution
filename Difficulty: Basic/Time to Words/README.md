<h2><a href="https://www.geeksforgeeks.org/problems/time-to-words3728/1?page=1&category=Strings&difficulty=Basic&sortBy=difficulty">Time to Words</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a time in the format of hh:mm (12-hour format) <em><strong>0 &lt; HH&nbsp;&lt; 12, 0 &lt;= MM&nbsp;&lt; 60</strong>.</em> The task is to convert it into words.</span></p>
