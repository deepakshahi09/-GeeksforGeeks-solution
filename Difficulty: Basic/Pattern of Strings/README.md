<h2><a href="https://www.geeksforgeeks.org/problems/pattern-of-strings3829/1?page=2&category=Strings&difficulty=Basic&sortBy=difficulty">Pattern of Strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s.</strong> Find the pattern of the strings in the examples below.</span></p>
