<h2><a href="https://www.geeksforgeeks.org/problems/perfect-square-string5914/1?page=2&category=Strings&difficulty=Basic&sortBy=difficulty">Perfect Square String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">You are given a string S. Your task is to determine if the sum of ASCII values of all character results in a perfect square or not. If it is a&nbsp;perfect square then the answer is 1, otherwise 0.</span></p>
