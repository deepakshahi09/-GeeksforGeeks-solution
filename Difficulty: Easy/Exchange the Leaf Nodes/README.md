<h2><a href="https://www.geeksforgeeks.org/problems/exchange-the-leaf-nodes/1?page=2&category=Tree&sortBy=difficulty">Exchange the Leaf Nodes</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a binary tree. you have to swap leaf nodes in the given binary tree pairwise starting from from left to right.</span></p>
