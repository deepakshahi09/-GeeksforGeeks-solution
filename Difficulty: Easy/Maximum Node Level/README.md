<h2><a href="https://www.geeksforgeeks.org/problems/maximum-node-level/1?page=1&category=Tree&sortBy=difficulty">Maximum Node Level</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Binary tree. Find the level in the binary tree which has the maximum number of nodes.</span></p>
