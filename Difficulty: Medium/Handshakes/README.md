<h2><a href="https://www.geeksforgeeks.org/problems/handshakes1303/1?page=5&category=Recursion&sortBy=difficulty">Handshakes</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">We have N&nbsp;persons sitting on a round table. Any person can do a handshake with any other person. </span></p>
